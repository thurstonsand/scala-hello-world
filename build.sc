...
trait CompileSettings extends ScalaModule {
...
trait AssemblySettings extends ScalaModule {
    def mainClass = Some("com.github.thurstonsand.helloworld.Main")
    def assemblyRules = Seq(
        Rule.Exclude("io.netty.versions.properties")
    )
}
...
object helloWorld extends ScalaModule 
    with ScalafmtModule 
    with DockerModule
    with CompileSettings
    with AssemblySettings {
    ...
    object docker extends DockerConfig {
        def tags = List("scala-hello-world")
	// def baseImage = "adoptopenjdk/openjdk8:alpine"
